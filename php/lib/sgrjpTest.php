...
/**
 * Test class for srjp.
 * Generated by PHPUnit on 2011-08-15 at 14:54:33.
 */
class srjpTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var srjp
     */
    ...
    public function testUrlEncodingToArray() {
        ...
        echo "<pre>";
        foreach ($urls as $u) {
            print_r($this->t->array_to_request_object($this->t->url_encoding_to_array($u)));
        }
        echo "</pre>";
    }
